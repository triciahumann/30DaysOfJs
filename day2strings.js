...
let numOfLove = newSentence.split('love').length;
console.log(numOfLove) // 3
...
conjunction' */
let matchBecause = sentence.match('because');
console.log(matchBecause)

/* 3. Clean the following text and find the most frequent word (hint, use replace and regular expressions).
    
    '%I $am@% a %tea@cher%, &and& I lo%#ve 
    %te@a@ching%;. The@re $is no@th@ing; &as& mo@re rewarding as 
    educa@ting &and& @emp%o@weri@ng peo@ple. ;I found tea@ching m%o@re 
    interesting tha@n any ot#her %jo@bs. %Do@es thi%s mo@tiv#ate yo@u 
    to be a tea@cher!? %Th#is 30#Days&OfJavaScript &is al@so $the 
    $resu@lt of &love& of tea&ching'
*/
let ridiculousSentence = '%I $am@% a %tea@cher%, &and& I lo%#ve %te@a@ching%;. The@re $is no@th@ing; &as& mo@re rewarding as educa@ting &and& @emp%o@weri@ng peo@ple. ;I found tea@ching m%o@re interesting tha@n any ot#her %jo@bs. %Do@es thi%s mo@tiv#ate yo@u to be a tea@cher!? %Th#is 30#Days&OfJavaScript &is al@so $the $resu@lt of &love& of tea&ching';
let cleanSentence = ridiculousSentence.replaceAll('%', "");
let cleanSentence2 = cleanSentence.replaceAll('$', "")
let cleanSentence3 = cleanSentence2.replaceAll('@', "");
let cleanSentence4 = cleanSentence3.replaceAll('#', "");
let cleanSentence5 = cleanSentence4.replaceAll('&', "");
